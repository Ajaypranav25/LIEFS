...
export const ArchitectureView: React.FC = () => {
  ...
  // KV Cache Formula:
  // KV_size_per_token = 2 (for K and V) * num_layers * num_kv_heads * head_dim * bytes_per_element
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-rose-500/20 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-mono text-rose-400 font-semibold">O(N²) Cost</span>
            </div>
            <h3 className="text-sm font-bold font-mono text-slate-100 mb-2">
            ...
            <div className="mt-3 p-2.5 rounded-lg bg-obsidian-950/80 border border-slate-800 text-[11px] font-mono text-slate-300 space-y-1">
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center gap-1.5 text-xs font-mono text-rose-400">
        ...
        {/* Stage 2: KV Cache */}
        <div className="glass-panel p-5 rounded-2xl border border-emerald-500/30 flex flex-col justify-between shadow-glow-emerald">
          <div>
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                Stage 2: KV-Cache
              </span>
              <span className="text-xs font-mono text-emerald-400 font-semibold">O(N) Decode</span>
            </div>
            <h3 className="text-sm font-bold font-mono text-slate-100 mb-2">
              Prefill + Decode Separation
            </h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Computes Key and Value tensors for historical tokens once and caches them. Each decode step only processes <code className="text-emerald-300">1 token</code> through the network.
            </p>
            <div className="mt-3 p-2.5 rounded-lg bg-obsidian-950/80 border border-slate-800 text-[11px] font-mono text-slate-300 space-y-1">
              <div className="text-emerald-400 font-semibold">Linear Attention Cost:</div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center gap-1.5 text-xs font-mono text-emerald-400">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-amber-500/20 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-mono text-amber-400 font-semibold">Iteration Scheduling</span>
            </div>
            <h3 className="text-sm font-bold font-mono text-slate-100 mb-2">
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center gap-1.5 text-xs font-mono text-amber-400">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-cyan-500/20 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-mono text-cyan-400 font-semibold">Virtual Memory Pool</span>
            </div>
            <h3 className="text-sm font-bold font-mono text-slate-100 mb-2">
            ...
            <div className="mt-3 p-2.5 rounded-lg bg-obsidian-950/80 border border-slate-800 text-[11px] font-mono text-slate-300 space-y-1">
              <div className="text-cyan-400 font-semibold">Zero Memory Fragmentation:</div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center gap-1.5 text-xs font-mono text-cyan-400">
        ...
        <div className="glass-panel p-5 rounded-2xl border border-purple-500/20 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-mono text-purple-400 font-semibold">Symmetric Linear</span>
            </div>
            <h3 className="text-sm font-bold font-mono text-slate-100 mb-2">
              Per-Channel INT8 Weights
            </h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Weights quantized to 8-bit integers with per-channel scale factors: <code className="text-purple-300">W_int8 = round(W / scale)</code>. Dequantized on the fly during forward pass.
            </p>
            <div className="mt-3 p-2.5 rounded-lg bg-obsidian-950/80 border border-slate-800 text-[11px] font-mono text-slate-300 space-y-1">
              <div className="text-purple-400 font-semibold">50% Weight VRAM Cut:</div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center gap-1.5 text-xs font-mono text-purple-400">
      ...
      <div className="glass-panel p-6 rounded-2xl">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Formula: <code className="text-emerald-400 font-mono">VRAM_KV = 2 × N_layers × N_kv_heads × d_head × precision_bytes × Seq_len × Batch_size</code>
            </p>
          </div>

          {/* Model Preset Selector */}
          <div className="flex items-center gap-2">
            <span className="text-xs font-mono text-slate-400">Model Preset:</span>
            <button
              onClick={() => {
                setNumLayers(24);
                setNumKVHeads(2);
              ...
              className="px-2.5 py-1 rounded bg-obsidian-950 border border-emerald-500/40 text-emerald-300 text-xs font-mono font-medium hover:bg-emerald-500/10 transition-all"
            >
              Qwen2.5-0.5B (GQA)
            </button>
            <button
              ...
              className="px-2.5 py-1 rounded bg-obsidian-950 border border-slate-800 text-slate-400 text-xs font-mono font-medium hover:text-slate-200 transition-all"
            >
              Llama-3-8B (GQA)
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-slate-400">Context Length (Tokens)</span>
                <span className="text-emerald-400 font-semibold">{contextLength.toLocaleString()}</span>
              </div>
              <input
                type="range"
                min="512"
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-slate-400">Batch Size (Concurrent Requests)</span>
                <span className="text-cyan-400 font-semibold">{batchSize}</span>
              </div>
              <input
                type="range"
                min="1"
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-mono">
                ...
                <span className="text-slate-200 font-semibold">{numLayers}</span>
              </div>
              <input
                type="range"
                min="12"
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-slate-400">KV Attention Heads (GQA)</span>
                <span className="text-slate-200 font-semibold">{numKVHeads}</span>
              </div>
              <input
                type="range"
                min="1"
            ...
            <div className="space-y-1 sm:col-span-2">
              <span className="text-xs font-mono text-slate-400 block mb-1">KV-Cache Quantization Precision</span>
                  ...
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-lg border text-xs font-mono transition-all ${
                      precisionBytes === p.bytes
                        ? 'bg-emerald-500/20 text-emerald-300 border-emerald-500/50 shadow-glow-emerald font-semibold'
          ...
          <div className="lg:col-span-5 bg-obsidian-950 p-5 rounded-xl border border-slate-800 flex flex-col justify-between space-y-4">
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-baseline justify-between border-b border-slate-800/80 pb-2">
                  <span className="text-xs font-mono text-slate-400">Memory Per Request:</span>
                ...
                <div className="flex items-baseline justify-between border-b border-slate-800/80 pb-2">
                  <span className="text-xs font-mono text-slate-400">Total KV Cache (Batch={batchSize}):</span>
                ...
                <div className="flex items-baseline justify-between border-b border-slate-800/80 pb-2">
                  <span className="text-xs font-mono text-slate-400">Max Concurrency ({gpuVramGb}GB GPU):</span>
            ...
            <div className="p-3 rounded-lg bg-emerald-500/5 border border-emerald-500/20 text-[11px] font-mono text-emerald-300">
